...
buttonpeq.setOnAction(e->Funequal1());
...
TextCal.setStyle("-fx-background-color:#white;-fx-text-fill:black;-fx-border-width:5px;-fx-border-color:gray;");
...
TextCal.setText(s);
	...
	if(Operation.duplicateOperator(s, '-'))
	{
	 s= (TextCal.getText());
	}else
	{
...
public void Funmiunsnumber() ///////// minus Button
    {
	String s=TextCal.getText();
	if(Operation.duplicateMinus(s, "-"))
	{
	 s= (TextCal.getText());
	}else
	{
